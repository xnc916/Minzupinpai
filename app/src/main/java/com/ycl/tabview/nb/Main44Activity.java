...
public class Main44Activity extends FragmentActivity implements FragmentMy.CallBackValue,FragmentMain.CallBackValuemain,FragmentShequ.She,FragmentShop.Shopggg{
    ...
    private void initView() {
        ...
        fragmentMain = FragmentMain.newInstance("http://3.1budai.com/mobile/user.php");
...
//                LogUtils.d("***************   double click  ******************");
    ...
    public void SendMessageValue(int i) {
        switch (i){
            case 1:
                finish();
                Intent intent1 = new Intent(Main44Activity.this,Main1Activity.class);
                startActivity(intent1);
                break;
            case 2:
                finish();
                Intent intent2 = new Intent(Main44Activity.this,Main2Activity.class);
                startActivity(intent2);
                break;
            case 3:
                finish();
                Intent intent3 = new Intent(Main44Activity.this,Main3Activity.class);
                startActivity(intent3);
                break;
            case 4:
                finish();
                Intent intent4 = new Intent(Main44Activity.this,Main4Activity.class);
