...
public class Main1Activity extends FragmentActivity implements FragmentMy.CallBackValue,FragmentMain.CallBackValuemain,FragmentShequ.She,FragmentShop.Shopggg{
...
//                LogUtils.d("***************   double click  ******************");
    ...
    public void SendMessageValue(final int i) {
        switch (i){
            ...
            case 2:
                finish();
                Intent intent2 = new Intent(Main1Activity.this,Main2Activity.class);
                startActivity(intent2);
                break;
            case 3:
                finish();
                Intent intent3 = new Intent(Main1Activity.this,Main3Activity.class);
                startActivity(intent3);
                break;
            case 4:
                finish();
                Intent intent4 = new Intent(Main1Activity.this,Main4Activity.class);
