...
public class Main4Activity extends FragmentActivity implements FragmentMy.CallBackValue,FragmentMain.CallBackValuemain,FragmentShequ.She,FragmentShop.Shopggg{
...
//                LogUtils.d("***************   double click  ******************");
    ...
    public void SendMessageValue(final int i) {
        switch (i){
            case 1:
                finish();
                Intent intent1 = new Intent(Main4Activity.this,Main1Activity.class);
            ...
            case 4:
                finish();
                Intent intent4 = new Intent(Main4Activity.this,Main44Activity.class);
