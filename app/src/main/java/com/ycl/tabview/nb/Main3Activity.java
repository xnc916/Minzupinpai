...
public class Main3Activity extends FragmentActivity implements FragmentMy.CallBackValue,FragmentMain.CallBackValuemain,FragmentShequ.She,FragmentShop.Shopggg{
...
//                LogUtils.d("***************   double click  ******************");
    ...
    public void SendMessageValue(final int i) {
        switch (i){
            case 1:
                finish();
                Intent intent1 = new Intent(Main3Activity.this,Main1Activity.class);
            ...
            case 3:
                finish();
                Intent intent3 = new Intent(Main3Activity.this,Main33Activity.class);
